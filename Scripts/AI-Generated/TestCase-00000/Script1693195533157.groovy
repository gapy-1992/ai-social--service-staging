...
'step 3: At Page_dvc-login input on input_r0_'

testObj = findTestObject('Object Repository/Page_dvc-login/input_r0_')
...
WebUI.setText(testObj, var_1_input_r0_)

'step 4: At Page_dvc-login input on input_r1_'

testObj = findTestObject('Object Repository/Page_dvc-login/input_r1_')
...
WebUI.setText(testObj, var_2_input_r1_)
...
'step 6: At Page_dvc-home click on button_object --> navigate to Page_dvc-home_money-form1'
...
'step 7: Add visual checkpoint at Page_dvc-home_money-form1'
